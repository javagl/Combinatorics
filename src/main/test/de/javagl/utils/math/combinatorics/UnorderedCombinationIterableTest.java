...
/**
 * Test cases for the {@link UnorderedCombinationIterable} class.
 */
@RunWith(JUnit4.class)
public class UnorderedCombinationIterableTest
{
    /**
     * Basic test for the {@link UnorderedCombinationIterable} class
     */
    @Test
    public void testBasic()
    {
        ...
        Set<List<String>> actual = 
            Utils.asSet(new UnorderedCombinationIterable<String>(sampleSize, input));
    ...
    public void testEmptyInput()
    {
        ...
        Iterable<List<String>> iterable = 
            new UnorderedCombinationIterable<String>(sampleSize, input);
